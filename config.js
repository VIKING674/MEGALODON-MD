...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~ldZXgY6R#JP0ELTGutn-sXU8EKLpWo52uXihSlRaiJ_oX_OJnb7Y",  // Your bot's session ID (keep it secure)
    
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    
    BOT_NAME: process.env.BOT_NAME || getConfig("MEGALODON") || "MEGALODON-MD",  // Bot's display name
    
    MODE: process.env.MODE || "public",        // Bot mode: public/private/group/inbox

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50943626477",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("VIKING") || "ADD YOUR NAME",           // Owner's name
